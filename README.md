...
The checked-in generated data is from Minecraft Java `26.2`.

It contains `3119` exported sprites in `public/minecraft-sprites`, including `63` animated textures with `.mcmeta` frame data.
